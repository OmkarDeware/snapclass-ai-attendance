...
from src.database.db import check_teacher_exists, create_teacher , teacher_login,get_teacher_subjects,get_attendance_teacher
...
def teacher_dashboard():
    ...
    with tab3:
        ...
        if st.button('Attendance Records', type=type3 ,width='stretch', icon="📊"):
