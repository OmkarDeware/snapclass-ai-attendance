                ...
                if st.button('Create Account', type='primary'):
                    if new_name:
                        with st.spinner('Creating Profile...'):
                            ...
                            if encodings:
                                face_mb = encodings[0].tolist()
                                
                                voice_mb = None
                                if audio_data:
                                    voice_mb = get_voice_embedding(audio_data.read())
                                
                                response_data = create_student(new_name, face_embedding = face_mb , voice_embedding = voice_mb)
